                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <p>
                                                ...
                                                <span class="float-right px-2 text-muted"><?= date_format(date_create($comment['comment_date']), "d F Y") ?></span>
                                            </p>
                    ...
                    <div class="post-comments">
                        ...
                        <form action="assest/insert.php?type=comment&id=<?= $article_id ?>#comment" method="POST">
                            <div class="form-group mt-3">
                                ...
                                <button name="submit" type="submit" class="btn btn-success float-right mt-1"  onclick="validateTextArea()">Add Comment</button>
                            </div>
                            <div class="clearfix"></div>
                        </form>
