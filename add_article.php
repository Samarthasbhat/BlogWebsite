...
<body class="d-flex flex-column min-vh-100">
    ...
    <main role="main" class="main">
        <div class="jumbotron text-center ">
            <h1 class="display-3 font-weight-normal">Add Article</h1>
        </div>
                ...
                <div class="col-lg-12 mb-4">
                    ...
                    <form action="assest/insert.php?type=article" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="artContent" id="artContent" rows="3" required></textarea>
                        </div>

                        <div class="form-group">
                            <label for="arImage">Image</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="arImage" id="arImage" required>
                        ...
                        <div class="text-center">
                            <button type="submit" name="submit" class="btn btn-login-success btn-lg w-25">Submit</button>
                        </div>
                    </form>
                </div>
