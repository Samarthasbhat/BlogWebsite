...
<style>
    .bg-div {
        background: linear-gradient(rgb(0, 0, 0),
                rgba(0, 0, 0, 0)), url("./img/slider/home.jpg");
        /* Full height */
        height: 800px;
    ...
    /* .section , .container, .section-grey{
        background:#02061f;
    } */
        ...
        <div class="jumbotron text-center p-0 mb-0">
            <div class="bg-div px-5 d-flex align-items-center ">
                ...
                <div class="text-center w-100">
                    <h1 class="display-4 text-white">Blog Website</h1>
                            ...
                            <div class="category-widget">
                                ...
                                <ul>
                                    ...
                                    <?php foreach ($categories as $category) : ?>
                                        <li>
                                            <a href="articleOfCategory.php?catID=<?= $category['category_id'] ?>"style="color: black"> <?= $category["category_name"] ?>
